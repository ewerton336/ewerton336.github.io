...
class PortfolioInteractions {
    ...
    setupFormValidation() {
        ...
        this.contactForm.addEventListener('submit', (e) => {
            ...
            const mailtoLink = `mailto:ewertonguimaraes2@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(
    ...
    showFormMessage(message, type) {
        ...
        messageEl.style.cssText = `
            ...
            border-radius: 8px;
            text-align: center;
            background: ${type === 'success' ? 'rgba(16, 255, 0, 0.1)' : 'rgba(255, 0, 0, 0.1)'};
            color: ${type === 'success' ? 'var(--green-neon)' : '#ff4444'};
            border: 1px solid ${type === 'success' ? 'var(--green-neon)' : '#ff4444'};
